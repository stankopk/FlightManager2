...
namespace FlightManager {
    ...
    public partial class FlightsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AccountsRow AddAccountsRow(int Id, string Username, string Password, string Email, string FirstName, string LastName, string PersonalID, string Adress, string PhoneNumber, bool IsAdmin) {
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public string PersonalID {
                get {
                    return ((string)(this[this.tableAccounts.PersonalIDColumn]));
                }
                set {
                    this[this.tableAccounts.PersonalIDColumn] = value;
                }
            }
            ...
            public string Adress {
                get {
                    return ((string)(this[this.tableAccounts.AdressColumn]));
                }
                set {
                    this[this.tableAccounts.AdressColumn] = value;
                }
            }
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Accounts] WHERE (([Id] = @Original_Id) AND ([Username] = @Orig" +
                "inal_Username) AND ([PersonalID] = @Original_PersonalID) AND ([PhoneNumber] = @O" +
                "riginal_PhoneNumber) AND ([IsAdmin] = @Original_IsAdmin))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Accounts] ([Id], [Username], [Password], [Email], [FirstName], [LastName], [PersonalID], [Adress], [PhoneNumber], [IsAdmin]) VALUES (@Id, @Username, @Password, @Email, @FirstName, @LastName, @PersonalID, @Adress, @PhoneNumber, @IsAdmin);
SELECT Id, Username, Password, Email, FirstName, LastName, PersonalID, Adress, PhoneNumber, IsAdmin FROM Accounts WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Accounts] SET [Id] = @Id, [Username] = @Username, [Password] = @Password, [Email] = @Email, [FirstName] = @FirstName, [LastName] = @LastName, [PersonalID] = @PersonalID, [Adress] = @Adress, [PhoneNumber] = @PhoneNumber, [IsAdmin] = @IsAdmin WHERE (([Id] = @Original_Id) AND ([Username] = @Original_Username) AND ([PersonalID] = @Original_PersonalID) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([IsAdmin] = @Original_IsAdmin));
SELECT Id, Username, Password, Email, FirstName, LastName, PersonalID, Adress, PhoneNumber, IsAdmin FROM Accounts WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Username, Password, Email, FirstName, LastName, PersonalID, Adress, Ph" +
                "oneNumber, IsAdmin FROM dbo.Accounts";
        ...
        public virtual int Fill(FlightsDBDataSet.AccountsDataTable dataTable) {
        ...
        public virtual FlightsDBDataSet.AccountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FlightsDBDataSet.AccountsDataTable dataTable = new FlightsDBDataSet.AccountsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FlightsDBDataSet.AccountsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Username, string Original_PersonalID, string Original_PhoneNumber, bool Original_IsAdmin) {
        ...
        public virtual int Insert(int Id, string Username, string Password, string Email, string FirstName, string LastName, string PersonalID, string Adress, string PhoneNumber, bool IsAdmin) {
        ...
        public virtual int Update(int Id, string Username, string Password, string Email, string FirstName, string LastName, string PersonalID, string Adress, string PhoneNumber, bool IsAdmin, int Original_Id, string Original_Username, string Original_PersonalID, string Original_PhoneNumber, bool Original_IsAdmin) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Password, string Email, string FirstName, string LastName, string PersonalID, string Adress, string PhoneNumber, bool IsAdmin, int Original_Id, string Original_Username, string Original_PersonalID, string Original_PhoneNumber, bool Original_IsAdmin) {
            return this.Update(Original_Id, Username, Password, Email, FirstName, LastName, PersonalID, Adress, PhoneNumber, IsAdmin, Original_Id, Original_Username, Original_PersonalID, Original_PhoneNumber, Original_IsAdmin);
        }
    }
